...
const Discover = () => {
  return (
    <div className="w-[100%] bg-[#f2f3ed] lg:py-2 lg:pr-3 overflow-auto">
      <div className="relative bg-white lg:rounded-md md:border border-[#ebece6] pb-4">
        <div className="mx-auto py-4 w-[93%] md:w-[90%] lg:w-[55%]">
          <div className="flex flex-row items-center gap-2">
            <svg
              ...
              data-prefix="fak"
              data-icon="discover"
              className="svg-inline--fa fa-discover fa-fw fa-1x w-8"
              role="img"
