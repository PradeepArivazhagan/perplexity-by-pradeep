const LargeCard = () => {
  return (
    <div>
      <div>
        <img
          className="rounded-t-md w-full h-64 md:h-40 lg:h-60 object-cover object-center"
      ...
      <div className="bg-[#f2f3ed]  pt-4 pb-3 pl-4 pr-2  rounded-b-md border-2 border-[#edeee9]">
        ...
        <p className="text-sm lg:text-base text-[#61615d] leading-6">
          ...
          porro sunt odit laboriosam est eligendi animi nostrum aperiam quaerat.
          Architecto, animi sunt unde..
        </p>
