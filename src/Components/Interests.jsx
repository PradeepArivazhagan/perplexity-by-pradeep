...
const Interests = () => {
  const [activeInterest, setActiveInterest] = useState("top");
  ...
  return (
    <div className="sticky -top-2 bg-white bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-90 py-3 mx-auto w-[93%] md:w-[90%] lg:w-[55%] flex flex-row overflow-auto no-scrollbar">
      <button
        onClick={() => handleInterestClick("top")}
        className={`w-fit py-1 px-3 lg:py-3 lg:px-4 flex flex-row items-center gap-1 rounded-md ${
          activeInterest === "top"
            ? "bg-[#e5efee] text-[#25838c]"
            : "text-[#384949]"
        }`}
      >
        <svg
          ...
          data-prefix="far"
          data-icon="star"
          className="svg-inline--fa fa-star fa-sm -translate-y-px delay-200 text-super w-3 lg:w-4"
          role="img"
      ...
      >
        <svg
          ...
          className="svg-inline--fa fa-microchip-ai fa-sm -translate-y-px delay-200 text-text w-4 lg:w-4"
          role="img"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 512 512"
        >
        ...
        <h1 className="text-xs font-semibold">Tech & Science</h1>
      </button>
      <button
        onClick={() => handleInterestClick("finance")}
        className={`w-fit py-1 px-3 lg:py-3 lg:px-4 flex flex-row items-center gap-1 rounded-md ${
          activeInterest === "finance"
            ? "bg-[#e5efee] text-[#25838c]"
            : "text-[#384949]"
        }`}
      >
        <svg
          ...
          className="svg-inline--fa fa-circle-dollar fa-sm -translate-y-px delay-200 text-text w-3 lg:w-4"
          role="img"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 512 512"
        >
        ...
        <h1 className="text-xs font-semibold">Finance</h1>
      </button>
      <button
      ...
      >
        <svg
          ...
          data-prefix="far"
          data-icon="palette"
          className="svg-inline--fa fa-palette fa-sm -translate-y-px delay-200 text-text w-3 lg:w-4"
          role="img"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 512 512"
        >
        ...
        <h1 className="text-xs font-semibold">Art & Culture</h1>
      </button>
      <button
      ...
      >
        <svg
          ...
          data-prefix="far"
          data-icon="medal"
          className="svg-inline--fa fa-medal fa-sm -translate-y-px delay-200 text-text w-3 lg:w-4"
          role="img"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 512 512"
        >
        ...
        <h1 className="text-xs font-semibold">Sports</h1>
      </button>
      <button
        onClick={() => handleInterestClick("entertainment")}
        className={`w-fit py-1 px-3 lg:py-3 lg:px-4 flex flex-row items-center gap-1 rounded-md ${
          activeInterest === "entertainment"
            ? "bg-[#e5efee] text-[#25838c]"
            : "text-[#384949]"
        }`}
      >
        <svg
          ...
          data-prefix="far"
          data-icon="tv"
          className="svg-inline--fa fa-tv fa-sm -translate-y-px delay-200 text-text w-3 lg:w-4"
          role="img"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 640 512"
        >
        ...
        <h1 className="text-xs font-semibold">Entertainment</h1>
      </button>
    </div>
  );
};
