const Interests = () => {
  return (
    <div className="sticky -top-2 bg-white bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-90 py-3 mx-auto w-[93%] md:w-[90%] lg:w-[55%] flex flex-row overflow-auto no-scrollbar">
      <div className="w-fit py-1 px-3 lg:py-3 lg:px-4 bg-[#e5efee] flex flex-row items-center gap-1 text-[#25838c] rounded-md">
        <svg
          aria-hidden="true"
          focusable="false"
          data-prefix="far"
      ...
      <div className="w-fit py-1 px-3 lg:py-3 lg:px-4 flex flex-row items-center gap-1 group rounded-md">
        <svg
          aria-hidden="true"
          focusable="false"
          data-prefix="far"
        ...
        <h1 className="text-xs font-semibold text-[#384949] group-hover:text-[#25838cd5]">
          Tech & Science
        </h1>
      </div>
      <div className="w-fit py-1 px-3 lg:py-3 lg:px-4 flex flex-row items-center gap-1 group rounded-md">
        <svg
          ...
          className="svg-inline--fa fa-circle-dollar fa-sm -translate-y-px delay-200 text-text w-3 lg:w-4 text-[#384949] group-hover:text-[#25838cd5]"
          role="img"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 512 512"
        >
      ...
      <div className="w-fit py-1 px-3 lg:py-3 lg:px-4 flex flex-row items-center gap-1 group rounded-md">
        <svg
          ...
          data-prefix="far"
          data-icon="palette"
          className="svg-inline--fa fa-palette fa-sm -translate-y-px delay-200 text-text w-3 lg:w-4 text-[#384949] group-hover:text-[#25838cd5]"
          role="img"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 512 512"
        >
      ...
      <div className="w-fit py-1 px-3 lg:py-3 lg:px-4 flex flex-row items-center gap-1 group rounded-md">
        <svg
          ...
          data-prefix="far"
          data-icon="medal"
          className="svg-inline--fa fa-medal fa-sm -translate-y-px delay-200 text-text w-3 lg:w-4 text-[#384949] group-hover:text-[#25838cd5]"
          role="img"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 512 512"
        >
      ...
      <div className="w-fit py-1 px-3 lg:py-3 lg:px-4 flex flex-row items-center gap-1 group rounded-md">
        <svg
          ...
          data-prefix="far"
          data-icon="tv"
          className="svg-inline--fa fa-tv fa-sm -translate-y-px delay-200 text-text w-3 lg:w-4 text-[#384949] group-hover:text-[#25838cd5]"
          role="img"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 640 512"
        >
